        ...
        .controller('queryCtrl',
            function ($scope, $log, $http, $rootScope, geolocation, locService) {
                ...
                $rootScope.$on("clicked", function () {
                    ...
                    // Run the locService functions associated with identifying coordinates
                    $scope.$apply(function () {
                        $scope.formData.latitude = parseFloat(locService.clickLat).toFixed(3);
                        $scope.formData.longitude = parseFloat(locService.clickLong).toFixed(3);
                    });
                });
